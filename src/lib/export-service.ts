...
export class ExportService {
  ...
  private async collectExportData(): Promise<ExportData> {
    ...
    return {
      ...
      settings: {
        ...
        siteDescription: 'Производство и продажа текстильных изделий',
        contactEmail: 'info@tekstil-complex.ru',
        contactPhone: '+7 (XXX) XXX-XX-XX',
        address: 'Адрес компании',
        workingHours: 'Пн-Пт: 9:00-18:00',
        socialLinks: {
          vk: 'https://vk.com/tekstil_complex',
          telegram: 'https://t.me/tekstil_complex',
        },
        deliverySettings: {
  ...
  private async createZIPExport(data: ExportData): Promise<Buffer> {
    ...
    zip.file('README.md', `# Экспорт данных Текстиль Комплекс
