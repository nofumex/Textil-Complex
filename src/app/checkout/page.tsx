...
export default function CheckoutPage() {
  ...
  const handleSubmit = async () => {
    try {
      if (!consent) {
        error('Требуется согласие', 'Поставьте галочку согласия на обработку персональных данных');
        return;
      }
      if (!isAuthenticated) {
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-start gap-2 text-xs text-gray-600">
                  ...
                  <span>
                    ...
                    <a href="/privacy" className="text-primary-600 hover:underline ml-1" target="_blank" rel="noopener noreferrer">Политики обработки персональных данных</a>.
                  </span>
                </label>
