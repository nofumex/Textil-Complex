...
export const ServicesSection: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      features: ['По Красноярску и Красноярскому краю', 'По Республике Хакасия и Иркутской области', 'Ближайшие края и Республики'],
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600">дня на пошив</div>
          </div>
          <div className="text-center">
