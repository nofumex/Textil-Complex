...
export const metadataTemplates = {
  home: {
    ...
    description: 'ООО Текстиль Комплекс — постельные принадлежности в наличии. Работаем с 2004 года. Быстрая доставка собственным автотранспортом. Большой склад, индивидуальный пошив.',
    keywords: 'постельное белье, текстиль, постельные принадлежности, оптом, розница, пошив, доставка, Красноярск',
  },
  catalog: {
    title: 'Каталог постельных принадлежностей',
    description: 'Широкий выбор постельного белья, подушек, одеял и наматрасников. Качественные материалы, доступные цены, быстрая доставка по Красноярску и Красноярскому краю.',
  ...
  contacts: {
    ...
    description: 'Свяжитесь с нами: телефон +7 (495) 123-45-67, email info@textil-kompleks.ru. Адрес: г. Красноярск, ул. Примерная, д. 123. Режим работы: Пн-Пт 9:00-18:00.',
    keywords: 'контакты, телефон, адрес, режим работы, связь',
  },
  delivery: {
    title: 'Доставка и оплата — Текстиль Комплекс',
    description: 'Доставка постельных принадлежностей по Красноярску и Красноярскому краю собственным автотранспортом. Различные способы оплаты. Быстрая отгрузка заказов.',
...
export function generateCategoryMetadata(categoryName: string, categorySlug: string) {
  return {
    title: `${categoryName} — купить в Красноярске | Текстиль Комплекс`,
    description: `Широкий выбор ${categoryName.toLowerCase()} высокого качества. Доставка по Красноярску и Красноярскому краю. Работаем с 2004 года.`,
...
export function generateProductMetadata(product: {
  ...
  return {
    ...
    description: product.description || `${product.title} из качественных материалов. ${product.material ? `Материал: ${product.material}.` : ''} Цена: ${priceText}. Доставка по Красноярску и Красноярскому краю.`,
