...
// Stable memoized helper components moved outside to avoid remounting inputs on each render
const Datalists: React.FC<{ colors: string[]; sizes: string[] }> = React.memo(({ colors, sizes }) => (
  <>
...
interface VariantEditorFormProps {
  ...
  isLoading: boolean;
  setEditingVariant: React.Dispatch<React.SetStateAction<VariantFormData | null>>;
  handleUploadColorImage: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handleCancelEdit: () => void;
  handleSaveVariant: () => void;
}

const VariantEditorForm: React.FC<VariantEditorFormProps> = ({
  editingVariant,
  isLoading,
  setEditingVariant,
